...
import interfaces.IRechnungAuftragRepository;

@Repository
public interface RechnungAuftragRepository extends JpaRepository<RechnungAuftrag, Long>, IRechnungAuftragRepository {
